...
// Resend-inloggningen (magisk länk via e-post) är avstängd tills en
// verifierad avsändardomän är konfigurerad i Resend. För att slå på den
// igen: avkommentera importerna nedan, avkommentera Resend-providern i
// providers-listan, och avkommentera e-postformuläret i
...
export const { handlers, auth, signIn, signOut } = NextAuth({
  ...
  providers: [
    ...
    //   from: process.env.AUTH_RESEND_FROM ?? "Tipslistan <onboarding@resend.dev>",
    ...
    //       to,
    //       subject: `Logga in på Tipslistan`,
    //       html: `
    ...
    //             <p style="font-family:Georgia, serif; font-style:italic; font-size:22px; margin:0 0 20px;">Tipslistan</p>
    ...
    //         </div>
    //       `,
    //       text: `Logga in på Tipslistan: ${url} (giltig i 24 timmar)`,
    //     });
